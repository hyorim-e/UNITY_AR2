...
IL_0019:
	{
		...
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_3 = __this->___hits_5;
		NullCheck(L_3);
		...
		L_5 = ARRaycastHit_get_pose_m84C13E71E21FE12CBA9AAD98DC28B1E414C9EFFD((&V_2), NULL);
		V_1 = L_5;
		...
		bool L_10;
		L_10 = Vector3_Equals_mEDEAF86793D229455BBF9BA5B30DDF438D6CABC1_inline((&V_3), L_9, NULL);
		if (!L_10)
		{
			goto IL_005b;
		}
	}
	{
		...
		NullCheck(L_11);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_11, _stringLiteral45EDE4DB19150515241E2FE6610B1490B1DED5C7, (bool)0, NULL);
		return;
	}
...
IL_005b:
	{
		...
		NullCheck(L_12);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_12, _stringLiteral45EDE4DB19150515241E2FE6610B1490B1DED5C7, (bool)1, NULL);
		// }
		return;
	}
}
