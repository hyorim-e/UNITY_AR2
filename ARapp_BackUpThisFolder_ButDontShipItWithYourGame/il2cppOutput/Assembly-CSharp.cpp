...
IL_0011:
	...
	}
	{
		...
		NavMeshAgent_t5D0CCC0B3B78242F286C9BD8EDD87C3CCBD0A66F* L_15 = __this->___agent_16;
		NullCheck(L_15);
		...
		if (!((((int32_t)((!(((float)L_18) <= ((float)(0.100000001f))))? 1 : 0)) == ((int32_t)0))? 1 : 0))
		{
			goto IL_009d;
		}
	}
	{
		...
		NullCheck(L_19);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_19, _stringLiteral45EDE4DB19150515241E2FE6610B1490B1DED5C7, (bool)0, NULL);
	}
...
IL_009d:
	{
		...
		Object_Destroy_m0E1B4CF8C29EB7FC8658C2C84C57F49C0DD12C91(L_24, (3.0f), NULL);
	}
